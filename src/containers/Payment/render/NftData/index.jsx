...
import LogoNFT from '@images/LogoNFT.png'
...
const NftData = props => {
  ...
  return (
    <div className={styles.NftData}>
      <img src={LogoNFT}/>
      <div className={styles.NftData__price}>
        <h4>Total price</h4>
        <div className={styles.NftData__priceAmount}>
          <h4>50 USD</h4>
          {/* <span>0.054 ETH</span> */}
        </div>
      </div>
      <div className={styles.NftData__infoYouPay}>
        <span><b>50 USD</b> is all you pay, all fees included</span>
